...
def info():
    stadium2 = df[(df['sport_played'] == 'Football') & (df['total_capacity'] > 15000)]\
                ['country'].sort_values().unique
    question=['World biggest stadium:', 'EU biggest stadium:', 'SA biggest stadium:', \
              'EU most +15k stadium', 'Asia most +15k stadium', 'Africa most +15k stadium']
